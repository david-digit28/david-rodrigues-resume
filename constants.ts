...
const DATA_FR: ResumeData = {
  ...
  // Reuse skills structure but keeping technical terms (often English) is standard in tech.
  // We translate categories where impactful.
  ...
  certificates: DATA_EN.certificates,
  languages: [
...
const DATA_ES: ResumeData = {
  ...
  projects: [
    ...
    },
    {
      ...
      description: [
        "Plataforma B2B estratégica diseñada para penetrar el mercado de la construcción de Arabia Saudita (Visión 2030, NEOM).",
