...
const DATA_EN: ResumeData = {
  ...
  skills: [
    ...
    { name: "Cloudflare Workers", category: "AI & Product Engineering", level: 84 },
    { name: "OpenNext", category: "AI & Product Engineering", level: 82 },
...
"UK-based immigration law firm. Joined when the firm operated a single Mumbai branch. Through digital transformation, SEO/PPC execution, and operational scaling, helped drive expansion to 3 India branches, UK market entry, and the firm's evolution into an AI-driven immigration practice.",
    ...
    },
    {
      ...
      description: [
        ...
        "Architecting and developing the RoofTech Industries SPC website using Next.js and TypeScript, with a Sanity headless CMS content architecture and deployment to Cloudflare Workers through OpenNext.",
      ...
      technologies: ["Digital Strategy", "Operations", "React", "Next.js", "TypeScript", "Sanity CMS", "Headless CMS", "Cloudflare Workers", "OpenNext", "Firebase", "Google Ads", "GTM", "AI Localization"]
    },
    {
      id: "exp-3",
      ...
      description: [
        "Delivered exceptional control over a ~$500k project portfolio by orchestrating Quantum ERP operations, ensuring precise fund allocation and informed strategic decision-making.",
  ...
  projects: [
    {
      id: "proj-8",
      title: "RoofTech CRM - Sales & Operations Platform",
      description: [
        "Architected a security-first CRM platform for RoofTech Industries SPC - bringing customer enquiries, sales opportunities, follow-ups, and operational activity into one structured system. Designed with role-based access, PostgreSQL Row Level Security, auditability and reliable data-ingestion foundations.",
        "RoofTech CRM is a full-stack sales and customer-operations platform I designed and am building for RoofTech Industries SPC. It transforms website enquiries into durable customer records and gives staff a unified workspace for managing leads, pipeline stages, assigned tasks, and customer timelines.",
        "The platform uses a privacy-conscious architecture with server-side authorization, validated external inputs, database constraints, and environment isolation. Its phased roadmap includes reliable website integration, email activity tracking, quotations, and controlled accounting-system integration.",
        "The result is a secure operational foundation designed to reduce missed follow-ups, improve sales visibility, preserve customer history, and support RoofTech’s growth without relying on disconnected spreadsheets and email threads."
      ],
      tags: ["Next.js 16", "React 19", "TypeScript", "Supabase PostgreSQL", "Supabase Auth", "Row Level Security", "Cloudflare Workers", "OpenNext", "Zod", "Vitest"],
      imageUrl: "https://ghoshgroups.com/download/rooftech-crm.png"
    },
    {
      id: "proj-6",
    ...
    description: [
      "Architecting a modern B2B website for RoofTech Industries SPC as part of my ongoing Ghosh Group digital engagement, using Next.js and TypeScript with a Sanity headless CMS content architecture.",
      ...
      "The platform is deployed to Cloudflare Workers using OpenNext, combining a responsive user experience, reusable content components, optimised media delivery, technical SEO, and conversion-focused enquiry journeys."
    ],
    tags: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Sanity CMS", "Cloudflare Workers", "OpenNext"],
...
const DATA_FR: ResumeData = {
  ...
  experience: [     {
      id: "exp-1",
      role: "Responsable de la transformation numérique, du budget et des ressources humaines",
      company: "The SmartMove2UK",
      location: "Genève, Télétravail",
  ...
  projects: [
    {
      id: "proj-8",
      title: "RoofTech CRM - Plateforme de vente et d'opérations",
      description: [
        "J'ai conçu une plateforme CRM axée sur la sécurité pour RoofTech Industries SPC, regroupant les demandes des clients, les opportunités commerciales, les suivis et les activités opérationnelles au sein d'un système structuré unique. Cette plateforme intègre un accès basé sur les rôles, la sécurité au niveau des lignes de données (Row Level Security) de PostgreSQL, des fonctionnalités d'audit et des fondements fiables pour l'ingestion des données.",
        "RoofTech CRM est une plateforme « full-stack » dédiée aux ventes et aux opérations clients que j’ai conçue et que je développe actuellement pour RoofTech Industries SPC. Elle transforme les demandes de renseignements reçues via le site web en fiches clients durables et offre au personnel un espace de travail unifié pour gérer les prospects, les étapes du pipeline, les tâches attribuées et les calendriers clients.",
        "La plateforme utilise une architecture respectueuse de la vie privée, avec une autorisation côté serveur, des entrées externes validées, des contraintes de base de données et une isolation des environnements. Sa feuille de route par étapes comprend une intégration fiable du site web, le suivi des activités par e-mail, les devis et une intégration contrôlée au système comptable.",
        "Le résultat est une base opérationnelle sécurisée, conçue pour réduire les oublis de suivi, améliorer la visibilité des ventes, préserver l’historique client et soutenir la croissance de RoofTech sans dépendre de feuilles de calcul et de fils de discussion par e-mail disparates."
      ],
      tags: ["Next.js 16", "React 19", "TypeScript", "Supabase PostgreSQL", "Supabase Auth", "Row Level Security", "Cloudflare Workers", "OpenNext", "Zod", "Vitest"],
      imageUrl: "https://ghoshgroups.com/download/rooftech-crm.png"
    },
    ...
    {
      id: "proj-7",
      title: "RoofTech Industries SPC - Plateforme B2B avec CMS headless",
      description: [
        "Conception d'un site web B2B moderne pour RoofTech Industries SPC dans le cadre de ma collaboration numérique continue avec Ghosh Group, avec Next.js, TypeScript et une architecture de contenu headless basée sur Sanity.",
        "Conception d'un système de contenu structuré permettant aux équipes non techniques de gérer de manière autonome les services, les projets, les visuels et le contenu de l'entreprise sans assistance d'un développeur.",
        "La plateforme est déployée sur Cloudflare Workers via OpenNext et combine une expérience responsive, des composants de contenu réutilisables, une diffusion optimisée des médias, un SEO technique et des parcours de demande orientés conversion."
      ],
      tags: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Sanity CMS", "Cloudflare Workers", "OpenNext"],
      imageUrl: "https://ghoshgroups.com/download/rooftech-headless-cms.jpg"
    },
...
const DATA_DE: ResumeData = {
  ...
  experience: [     {
      id: "exp-1",
      role: "Leiter für digitale Transformation, Budget & Personalwesen",
      company: "The SmartMove2UK",
      location: "Genf, Remote",
  ...
  projects: [
    {
      id: "proj-8",
      title: "RoofTech CRM - Vertriebs- und Betriebsplattform",
      description: [
        "Entwicklung einer CRM-Plattform für RoofTech Industries SPC, bei der die Sicherheit im Vordergrund steht - sie vereint Kundenanfragen, Verkaufschancen, Nachfassaktionen und betriebliche Aktivitäten in einem strukturierten System. Die Plattform basiert auf rollenbasierten Zugriffsrechten, PostgreSQL Row Level Security, Nachvollziehbarkeit und einer zuverlässigen Grundlage für die Datenerfassung.",
        "RoofTech CRM ist eine Full-Stack-Plattform für Vertrieb und Kundenmanagement, die ich für RoofTech Industries SPC entworfen habe und derzeit aufbaue. Sie wandelt Website-Anfragen in dauerhafte Kundendatensätze um und bietet den Mitarbeitenden einen einheitlichen Arbeitsbereich für die Verwaltung von Leads, Pipeline-Phasen, zugewiesenen Aufgaben und Kundenzeitplänen.",
        "Die Plattform nutzt eine datenschutzorientierte Architektur mit serverseitiger Autorisierung, validierten externen Eingaben, Datenbankbeschränkungen und Umgebungsisolierung. Die stufenweise Roadmap umfasst eine zuverlässige Website-Integration, die Nachverfolgung von E-Mail-Aktivitäten, Offerten sowie eine kontrollierte Integration in das Buchhaltungssystem.",
        "Das Ergebnis ist eine sichere operative Grundlage, die darauf ausgelegt ist, versäumte Nachfassaktionen zu reduzieren, die Transparenz im Vertrieb zu verbessern, die Kundenhistorie zu bewahren und das Wachstum von RoofTech zu unterstützen, ohne auf unzusammenhängende Tabellenkalkulationen und E-Mail-Verläufe angewiesen zu sein."
      ],
      tags: ["Next.js 16", "React 19", "TypeScript", "Supabase PostgreSQL", "Supabase Auth", "Row Level Security", "Cloudflare Workers", "OpenNext", "Zod", "Vitest"],
      imageUrl: "https://ghoshgroups.com/download/rooftech-crm.png"
    },
    ...
    {
      id: "proj-7",
      title: "RoofTech Industries SPC - B2B-Plattform mit Headless CMS",
      description: [
        "Konzeption einer modernen B2B-Website für RoofTech Industries SPC im Rahmen meiner laufenden digitalen Zusammenarbeit mit der Ghosh Group, mit Next.js, TypeScript und einer auf Sanity basierenden Headless-Content-Architektur.",
        "Entwicklung eines strukturierten Content-Systems, mit dem nichttechnische Teams Dienstleistungen, Projekte, Bildmaterial und Unternehmensinhalte eigenständig und ohne Unterstützung durch Entwickler verwalten können.",
        "Die Plattform wird über OpenNext auf Cloudflare Workers bereitgestellt und kombiniert ein responsives Nutzererlebnis, wiederverwendbare Content-Komponenten, optimierte Medienbereitstellung, technisches SEO und konversionsorientierte Anfrageprozesse."
      ],
      tags: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Sanity CMS", "Cloudflare Workers", "OpenNext"],
      imageUrl: "https://ghoshgroups.com/download/rooftech-headless-cms.jpg"
    },
...
const DATA_ES: ResumeData = {
  ...
  experience: [     {
      id: "exp-1",
      role: "Responsable de Transformación Digital, Presupuesto y RR. HH.",
      company: "The SmartMove2UK",
      location: "Ginebra, Teletrabajo",
  ...
  projects: [
    {
      id: "proj-8",
      title: "RoofTech CRM - Plataforma de ventas y operaciones",
      description: [
        "He diseñado una plataforma CRM centrada en la seguridad para RoofTech Industries SPC, que integra las consultas de los clientes, las oportunidades de venta, los seguimientos y la actividad operativa en un único sistema estructurado. Diseñada con acceso basado en roles, seguridad a nivel de fila de PostgreSQL, capacidad de auditoría y una base sólida para la ingesta fiable de datos.",
        "RoofTech CRM es una plataforma integral de ventas y operaciones de atención al cliente que he diseñado y estoy desarrollando para RoofTech Industries SPC. Transforma las consultas recibidas a través de la página web en registros de clientes duraderos y ofrece al personal un espacio de trabajo unificado para gestionar clientes potenciales, etapas del proceso de ventas, tareas asignadas y cronologías de los clientes.",
        "La plataforma utiliza una arquitectura centrada en la privacidad con autorización del lado del servidor, entradas externas validadas, restricciones de base de datos y aislamiento del entorno. Su hoja de ruta por fases incluye una integración fiable con el sitio web, el seguimiento de la actividad de correo electrónico, la elaboración de presupuestos y la integración controlada con el sistema contable.",
        "El resultado es una base operativa segura diseñada para reducir los seguimientos omitidos, mejorar la visibilidad de las ventas, conservar el historial de los clientes y respaldar el crecimiento de RoofTech sin depender de hojas de cálculo inconexas ni hilos de correo electrónico."
      ],
      tags: ["Next.js 16", "React 19", "TypeScript", "Supabase PostgreSQL", "Supabase Auth", "Row Level Security", "Cloudflare Workers", "OpenNext", "Zod", "Vitest"],
      imageUrl: "https://ghoshgroups.com/download/rooftech-crm.png"
    },
    ...
    {
      id: "proj-7",
      title: "RoofTech Industries SPC - Plataforma B2B con CMS headless",
      description: [
        "Diseño de un sitio web B2B moderno para RoofTech Industries SPC como parte de mi colaboración digital continua con Ghosh Group, utilizando Next.js, TypeScript y una arquitectura de contenidos headless basada en Sanity.",
        "Diseño de un sistema de contenido estructurado que permite a los equipos no técnicos gestionar de forma autónoma los servicios, los proyectos, las imágenes y el contenido corporativo sin depender de un desarrollador.",
        "La plataforma se despliega en Cloudflare Workers mediante OpenNext y combina una experiencia responsive, componentes de contenido reutilizables, entrega optimizada de medios, SEO técnico y recorridos de consulta orientados a la conversión."
      ],
      tags: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Sanity CMS", "Cloudflare Workers", "OpenNext"],
      imageUrl: "https://ghoshgroups.com/download/rooftech-headless-cms.jpg"
    },
